...
import { t as require_jsx_runtime } from "./jsx-runtime-Ba5-GtQW.js";
...
function getTileClasses(args) {
	...
	if (hover && (Array.isArray(value) ? value : [value]).length === 1) {
		var hoverRangeClassNames = getRangeClassNames(hover > valueRange[0] ? [valueRange[0], hover] : [hover, valueRange[0]], dateRange, "".concat(className$7, "--hover"));
